			                ...
			                <div class="card-body">
			                	<form action="slider_edit_processor.php" method="post" >
									...
									<div class="form-group">
										<label>Title</label>
										<input name="title" type="text" class="form-control" placeholder="Eugene Kopyov" value="<?=$slide->title?>" />
									</div>

									<div class="form-group">
										<label>Caption</label>
										<input name="caption" type="text" class="form-control" placeholder="Your strong password" value="<?=$slide->caption?>" />
									</div>

									<div class="form-group">
										<label>Alt</label>
										<input name="alt" type="text" class="form-control" placeholder="alt" value="<?=$slide->alt?>" />
									</div>

                                    <div class="form-group">
										<label>URL</label>
										<input name="url" type="text" class="form-control" placeholder="Your strong password" value="<?=$slide->src?>" />
									</div>
